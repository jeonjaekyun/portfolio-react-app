        ...
        <div style={{ width: '100%', margin: '0' }}>
            <div style={{ width: '85%', margin: '1rem auto' }}>
                ...
                <div style={{ marginTop: '40px' }}>
                    ...
                    웹 개발은 Java를 활용한 Spring Framework로 시작하였지만 Frontend를 공부해 보기 위해
                    React를 공부하다가 Nodejs에 대해서 알게 되고 공부하게 되었습니다. 이러한 과정을 통해
                    Javascript를 사용하면 Back, Front 심지어 MongoDB 같은 DB도 
                    다룰 수 있다는 편리함과 확장성이 있다는 것에 재미를 느끼며 학습하고 있습니다.
                    </p>
                </div>
                <div style={{ marginTop: '40px' }}>
                    <div style={{width:'100px'}}>
